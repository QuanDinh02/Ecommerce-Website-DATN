...
module.exports = function (sequelize, DataTypes) {
  var ProductReview = /*#__PURE__*/function (_Model) {
    function ProductReview() {
      _classCallCheck(this, ProductReview);
      return _callSuper(this, ProductReview, arguments);
    }
    _inherits(ProductReview, _Model);
    return _createClass(ProductReview, null, [{
      ...
      value: function associate(models) {
        ...
        ProductReview.belongsTo(models.Seller, {
          foreignKey: 'shopID'
        });
        ProductReview.hasOne(models.OrderProductReview, {
