  ...
  var Product = /*#__PURE__*/function (_Model) {
    ...
    return _createClass(Product, null, [{
      ...
      value: function associate(models) {
        ...
        Product.hasMany(models.ProductSubCategory, {
          foreignKey: 'productID'
        });
        Product.hasMany(models.Tag, {
          foreignKey: 'productID'
        });
        Product.hasMany(models.UserActivity, {
          foreignKey: 'productID'
        });
        ...
        Product.hasMany(models.RecommendProduct, {
        ...
        Product.hasMany(models.SimItem, {
          foreignKey: 'item_id'
        });
        Product.hasMany(models.SimItem, {
          foreignKey: 'item_rec'
        });
        Product.hasOne(models.ProductTracking, {
          foreignKey: 'productID'
        });
