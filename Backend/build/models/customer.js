...
module.exports = function (sequelize, DataTypes) {
  var Customer = /*#__PURE__*/function (_Model) {
    function Customer() {
      ...
      return _callSuper(this, Customer, arguments);
    }
    ...
    return _createClass(Customer, null, [{
      ...
      value: function associate(models) {
        ...
        Customer.hasMany(models.RecommendProduct, {
          foreignKey: 'customerID'
        });
        Customer.hasMany(models.RecommendThreeSessionProduct, {
          foreignKey: 'customerID'
        });
        Customer.hasMany(models.HistoryRecommendProduct, {
          foreignKey: 'customerID'
        });
        Customer.hasMany(models.TrainingWebData, {
          foreignKey: 'customerID'
        });
        Customer.hasOne(models.NewCustomer, {
          foreignKey: 'customerID'
        });
      }
    }]);
