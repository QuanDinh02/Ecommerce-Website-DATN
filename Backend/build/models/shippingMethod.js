...
module.exports = function (sequelize, DataTypes) {
  var ShippingMethod = /*#__PURE__*/function (_Model) {
    function ShippingMethod() {
      _classCallCheck(this, ShippingMethod);
      return _callSuper(this, ShippingMethod, arguments);
    }
    _inherits(ShippingMethod, _Model);
    return _createClass(ShippingMethod, null, [{
      key: "associate",
      value: function associate(models) {
        ShippingMethod.belongsTo(models.ShippingUnit, {
          foreignKey: 'unitID'
        });
