...
module.exports = function (sequelize, DataTypes) {
  var Seller = /*#__PURE__*/function (_Model) {
    function Seller() {
      _classCallCheck(this, Seller);
      return _callSuper(this, Seller, arguments);
    }
    _inherits(Seller, _Model);
    return _createClass(Seller, null, [{
      key: "associate",
      value: function associate(models) {
        Seller.belongsTo(models.User, {
          foreignKey: 'userID'
        });
        Seller.hasMany(models.ProductReview, {
          foreignKey: 'shopID'
        });
        Seller.hasMany(models.SubCategory, {
          foreignKey: 'shopID'
        });
