...
module.exports = function (sequelize, DataTypes) {
  var Provinces = /*#__PURE__*/function (_Model) {
    function Provinces() {
      _classCallCheck(this, Provinces);
      return _callSuper(this, Provinces, arguments);
    }
    _inherits(Provinces, _Model);
    return _createClass(Provinces, null, [{
      key: "associate",
      value: function associate(models) {
        Provinces.belongsTo(models.Administrative_Regions, {
          foreignKey: 'administrative_region_id'
        });
        Provinces.belongsTo(models.Administrative_Units, {
