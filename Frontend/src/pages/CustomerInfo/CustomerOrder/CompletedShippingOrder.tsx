...
const CompletedShippingOrder = () => {
    ...
    return (
        <div className="all-order-container">
            <div className="text-xl pb-4 border-b border-gray-300 mb-4">Đơn hàng đã giao</div>
            {
                (orderList && orderList.length > 0) ?
                    ...
                    :
                    <div className="w-full text-gray-500 text-center border border-gray-100 bg-gray-100 py-2">Chưa có đơn hàng đã giao nào !</div>
            }
...
export default CompletedShippingOrder;