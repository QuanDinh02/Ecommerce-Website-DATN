...
import { getSUOrderDetail } from "@/services/shippingUnitService";
...
const SUOrderDetail = () => {
    ...
    const fetchOrderDetail = async () => {
        let result = await getSUOrderDetail(orderID);
        if (result) {
                                ...
                                <div className="order-detail__main">
                                    ...
                                    <div className="order-info grid grid-cols-2 gap-x-6 gap-y-1 mt-4 border-t border-gray-300 pt-4">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <div className="font-medium mb-2">Thông tin người bán</div>
                                                <div className="mb-2 text-sm flex items-center justify-between">
                                                    <span className="text-gray-600">Tên shop</span>
                                                    <span className="font-medium">{orderDetailInfo.seller_info.name}</span>
                                                </div>
                                                <div className="mb-2 text-sm flex items-center justify-between">
                                                    <span className="text-gray-600">Số điện thoại</span>
                                                    <span className="font-medium">{orderDetailInfo.seller_info.mobile}</span>
                                                </div>
                                                <div className="mb-2 text-sm flex items-center justify-between">
                                                    <span className="text-gray-600">Địa chỉ</span>
                                                    <span className="font-medium">{orderDetailInfo.seller_info.address}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
