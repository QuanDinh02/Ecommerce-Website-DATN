...
const orderItemList = [
    {
        product_id: 57881,
        product_name: "Máy Sấy Tóc Panasonic EH-ND21-P645 - Hàng Chính Hãng",
        price: 10000,
        quantity: 1,
    }
]
...
const OrderDetail = () => {
    ...
    React.useEffect(() => {
        ...
        let activeOrderStatus: string = order_status ? order_status : "";
        if (activeOrderStatus !== orderStatus) {
            setOrderStatus(activeOrderStatus);
        }

    }, [searchParams.get('status')]);

    return (
        <div className="order-detail-container h-screen">
            <div className="order-detail__header mb-4">
                ...
                <div className="flex items-center mt-2 text-sm pb-2 border-b border-gray-300">
                    <div className="flex-1">Ngày đặt hàng: <span className="font-medium">09/04/2023 08:23</span></div>
                    <div className="flex-1">Hình thức thanh toán: <span className="font-medium">Thanh toán bằng tiền mặt</span></div>
                </div>
            </div>
            <div className="order-detail__main">
                ...
                <div className="order-info grid grid-cols-2 gap-x-6 gap-y-2 mt-4 border-t border-gray-300 pt-4">
                    <div>
                        ...
                        <div className="mb-2 text-sm flex items-center justify-between">
                            ...
                            <span className="font-medium">Thanh toán tiền mặt khi nhận hàng</span>
                        </div>
                        <div className="text-sm flex items-center justify-between">
                            <span className="text-gray-600">Tiền khách trả</span>
                            <span className="font-medium">{CurrencyFormat(1200000)}</span>
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="text-sm flex">
                            ...
                            <span className="font-medium flex-1 text-right">123 Nguyễn Văn Trỗi, Phường 5, Quận 3, TPHCM</span>
                        </div>
                    </div>
                    <div>
