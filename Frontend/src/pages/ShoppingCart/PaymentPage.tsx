...
const SuccessAnnouncement = () => {
    ...
    return (
        <div className="border border-gray-200 shadow py-6 w-fit px-12">
            ...
            <div className="text-center">Bạn có thể xem lại <span className="text-blue-600 hover:underline cursor-pointer" onClick={() => navigate("/customer-info/order/status")}>đơn hàng của tôi</span></div>
        </div>
    )
}
